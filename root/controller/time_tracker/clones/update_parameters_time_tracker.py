...
def update_parameters_time_tracker(data, hyperparameters: HyperparametersModel, variational_parameters: VariationalParameters, starting_parameters : VariationalParameters):
    #update parameters
...
def update_NIW(y, starting_parameters : VariationalParameters,
    ...
    TimeTracker.stop_and_save('update_NIW_PHI', tic)
