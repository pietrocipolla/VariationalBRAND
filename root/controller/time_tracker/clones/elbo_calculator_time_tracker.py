...
def elbo_calculator_time_tracker(data, hyper: HyperparametersModel, var_param: VariationalParameters, p, psi_dp=None):
    ...
    TimeTracker.stop_and_save('e_init', tic)
    ...
    TimeTracker.stop_and_save('e_diga', tic)
    ...
    TimeTracker.stop_and_save('e_f1f2', tic)
    #
    #
    # #f3 e f4
    tic = TimeTracker.start()
    ...
    TimeTracker.stop_and_save('e_f3f4', tic)
    # f5 #old version
    # f5=0
    # print(eta_k)
    # for k in range(1,J):
    ...
    TimeTracker.stop_and_save('e_f5', tic)
...
#     print('f6 vec', f6)
    ...
    print('f6 done', f6)
    TimeTracker.stop_and_save('e_f6', tic)
    #
    ...
    #
    print('f7 done', f7)
    TimeTracker.stop_and_save('e_f7', tic)
    ...
    print('f8 done',f8)
    TimeTracker.stop_and_save('e_f8', tic)
    ...
    print('h1 done', h1)
    TimeTracker.stop_and_save('e_h1', tic)
    ...
    print('h2 done', h2)
    TimeTracker.stop_and_save('e_h2', tic)
   ...
   #
    ...
    print('h3 done', h3)
    TimeTracker.stop_and_save('e_h3', tic)
    ...
    TimeTracker.stop_and_save('e_h4h5', tic)
