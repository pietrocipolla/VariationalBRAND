...
from root.controller.specify_user_input.user_input import specify_user_input
...
class Test(TestCase):
    def test_specify_user_input(self):
        ...
        #O_DP
        self.assertEqual(user_input.mu_0_DP[0].shape, (1, 2))
        self.assertEqual(user_input.nu_0_DP[0].shape, (1,))
        self.assertEqual(user_input.lambda_0_DP[0].shape, (1, ))
        self.assertEqual(user_input.PHI_0_DP[0].shape, (2,2))

        #0_MIX
        self.assertEqual(user_input.mu_0_MIX[0].shape, (2,))
        self.assertEqual(user_input.nu_0_MIX.shape, (3,))
        ...
        self.assertEqual(user_input.eta_k[0].shape, (4,))
        self.assertEqual(len(user_input.eta_k), 1)
        ...
        self.assertEqual(user_input.mu_var_DP[0].shape, (1,2))

        self.assertEqual(len(user_input.nu_var_DP), 1)
        self.assertEqual(user_input.nu_var_DP[0].shape, (5,))

        self.assertEqual(len(user_input.lambda_var_DP), 1)
        self.assertEqual(user_input.lambda_var_DP[0].shape, (5,))
